...
<div class="row">
  ...
  <form method="POST" action="{{ route('admin.billing.categories.store') }}" enctype="multipart/form-data">
    <div class="col-xs-12">
                ...
                <div class="col-md-4 text-center">
                  <div class="form-group col-md-12">
                    <div class="image-upload">
                      <label for="imgInp">
                        <img id="img-upload" src="/uploads/categories/default.png" height="200" width="200" style="border-radius: 50%;">
                        <input type="file" name="select_file" id="imgInp" style="display: none;" />
                      </label>
                    </div>
